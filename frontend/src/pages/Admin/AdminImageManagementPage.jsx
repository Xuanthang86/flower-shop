...
const readImageFile = (file, onSuccess, onError) => {
  ...
  reader.onerror = () => {
    onError("Không thể đọc hình ảnh.");
  };
    ...
    readImageFile(
      ...
      (image) => {
        try {
          ...
          const updatedSettings = saveSiteSettings({
            ...settings,
            hero: {
              ...settings.hero,
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Quản lý hình ảnh Banner và xem toàn bộ hình ảnh sản phẩm.
          </p>
        </div>
        ...
        {activeTab === "banners" && (
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-4 border-b border-gray-100 pb-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <label className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-pink-600 px-4 py-2.5 font-semibold text-white transition hover:bg-pink-700">
                <FiUpload />
                Thêm banner
                <input
                  type="file"
        ...
        {activeTab === "products" && (
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="border-b border-gray-100 pb-5">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Chỉ xem hình ảnh. Không chỉnh sửa hoặc xóa sản phẩm tại khu vực
                này.
              </p>
            </div>
