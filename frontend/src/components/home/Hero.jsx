...
const getBannerImage = (banner) =>
  banner?.image || banner?.desktopImage || banner?.imageUrl || "";
            ...
            {displayBanners.length > 1 && (
              <>
                <button
                  type="button"
                  onClick={goPrevious}
                  className="absolute left-3 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/85 text-gray-700 shadow-sm hover:bg-white hover:text-pink-600 md:left-4 md:h-10 md:w-10"
                ...
                <button
                  type="button"
                  onClick={goNext}
                  className="absolute right-3 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/85 text-gray-700 shadow-sm hover:bg-white hover:text-pink-600 md:right-4 md:h-10 md:w-10"
