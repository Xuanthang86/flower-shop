      ...
      <article className="group overflow-hidden rounded-xl bg-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-md">
        ...
        <div className="p-3">
          ...
          <div className="mt-3 flex w-full gap-2">
            <Link
              to={`/products/${product.id}`}
              className={`flex min-w-0 flex-1 items-center justify-center whitespace-nowrap rounded-lg px-2 py-2 text-center text-[11px] font-semibold text-white transition sm:text-xs ${
                isStaff
